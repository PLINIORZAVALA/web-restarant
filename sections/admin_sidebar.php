                    ...
                    <div id="sidebar-scroll">
                        ...
                        <div class="sidebar-content">
                            ...
                            <a href="#" class="sidebar-brand">
                                <i class="gi gi-flash"></i><span class="sidebar-nav-mini-hide"><strong>SGA </strong>UNAMBA</span>
                            </a>
                            <!-- END Brand -->
                            ...
                            <div class="sidebar-section sidebar-user clearfix sidebar-nav-mini-hide">
                                ...
                                <div class="sidebar-user-name">Luis Miguel</div>
                            ...
                            <ul class="sidebar-nav">
                                <li>
                                    <a href="index.html" class=" active"><i class="gi gi-stopwatch sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Inicio</span></a>
                                </li>
                                <li class="sidebar-header">
                                    ...
                                    <span class="sidebar-header-title">TITULO MENU</span>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><i class="gi gi-charts sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Menu</span></a>
                                </li>
                                <li>
                                    <a href="#" class="sidebar-nav-menu"><i class="fa fa-angle-left sidebar-nav-indicator sidebar-nav-mini-hide"></i><i class="gi gi-brush sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Menu</span></a>
                                    <ul>
                                        <li>
                                            <a href="#" class="sidebar-nav-submenu"><i class="fa fa-angle-left sidebar-nav-indicator"></i>Submenu</a>
                                            <ul>
                                                <li>
